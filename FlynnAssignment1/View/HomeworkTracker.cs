...
{
    /// <summary>
    ///     Created to store course information regards priority of class and
    ///     all tasked required in class
    /// </summary>
    public partial class CourseInfo : Form
    {
        ...
        private readonly int Cs3202TabPage = 0;
        private readonly int Engl1102TabPage = 1;
        private readonly int Chem1212TabPage = 2;
        ...
        /// <summary>Initializes courseInfo</summary>
        public CourseInfo()
        {
        ...
        private void loadNewPrioritiesFromCsvFile(ClassTaskLibrary.CourseInfo currentCourseInfo,
            string currentCoursesTitle)
        {
